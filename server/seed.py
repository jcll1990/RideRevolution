...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        item15 = Item(image = "/images/brakes/brakes5.png", stock=35, category="Motorcycle Brakes", type = "Motorcycle upgrades" ,brand="Blaze Tech", name="RevolutionBrake 12000", price=449.99, description="Join the braking revolution with Blaze Tech's RevolutionBrake 12000 upgrade. Advanced technology and precision engineering for unparalleled braking control.")

        item16 = Item(image = "/images/helmets/helmets1.png", stock=35, category="Helmets", type = "Motorcycle gear" ,brand="Velocity Tech", name="AeroSafe X-550", price=199.99, description="Experience maximum safety and style with Velocity Tech's AeroSafe X-550 helmet. Designed for aerodynamics and comfort on every ride.")
        item17 = Item(image = "/images/helmets/helmets2.png", stock=25, category="Helmets", type = "Motorcycle gear" ,brand="Thunder Force", name="GuardianRide 700R", price=229.99, description="Ride with the protection of a guardian with Thunder Force's GuardianRide 700R helmet. Combining safety features and a sleek design for a confident journey.")
        item18 = Item(image = "/images/helmets/helmets3.png", stock=15, category="Helmets", type = "Motorcycle gear" ,brand="Blaze Tech", name="BlazeArmor 8000X", price=179.99, description="Elevate your riding experience with Blaze Tech's BlazeArmor 8000X helmet. Superior protection and a cutting-edge design for the modern rider.")
        item19 = Item(image = "/images/helmets/helmets4.png", stock=35, category="Helmets", type = "Motorcycle gear" ,brand="Velocity Tech", name="SwiftGuard 950", price=249.99, description="Ride with swiftness and protection in Velocity Tech's SwiftGuard 950 helmet. A perfect blend of agility and safety for the adventurous rider.")
        item20 = Item(image = "/images/helmets/helmets5.png", stock=25, category="Helmets", type = "Motorcycle gear" ,brand="Blaze Tech", name="ZenithHelm 1100", price=269.99, description="Reach the zenith of safety with Blaze Tech's ZenithHelm 1100. Unmatched protection and a stylish design for riders who demand the best.")
        item21 = Item(image = "/images/helmets/helmets6.png", stock=15, category="Helmets", type = "Motorcycle gear" ,brand="Thunder Force", name="ThunderStrike 1200GT", price=299.99, description="Feel the strike of thunder with Thunder Force's ThunderStrike 1200GT helmet. Unleash a combination of safety and performance for an exhilarating ride.")

        item22 = Item(image = "/images/jackets/jackets1.png", stock=50, category="Jackets", type = "Motorcycle gear" ,brand="Velocity Tech", name="SwiftRider X-700", price=349.99, description="Ride in style with Velocity Tech's SwiftRider X-700 leather jacket. Crafted for comfort and durability, this jacket complements your adventurous spirit.")
        item23 = Item(image = "/images/jackets/jackets2.png", stock=35, category="Jackets", type = "Motorcycle gear" ,brand="Thunder Force", name="ThunderStrike 850GT", price=399.99, description="Feel the thunderous style with Thunder Force's ThunderStrike 850GT leather jacket. Unleash your boldness with this combination of fashion and functionality.")
        item24 = Item(image = "/images/jackets/jackets3.png", stock=45, category="Jackets", type = "Motorcycle gear" ,brand="Blaze Tech", name="InfernoFlex 6000X", price=299.99, description="Ignite your style with Blaze Tech's InfernoFlex 6000X leather jacket. A perfect fusion of flexibility and fashion, designed for the modern rider.")
        ...
        item28 = Item(image = "/images/boots/boots1.png", stock=50, category="Boots", type = "Motorcycle gear" ,brand="Velocity Tech", name="TurboStride X-550", price=179.99, description="Step into speed with Velocity Tech's TurboStride X-550 motorcycle boots. Engineered for both comfort and style, these boots are a perfect companion for your rides.")
        item29 = Item(image = "/images/boots/boots2.png", stock=55, category="Boots", type = "Motorcycle gear" ,brand="Thunder Force", name="ThunderGrip 700R", price=199.99, description="Grip the road with Thunder Force's ThunderGrip 700R motorcycle boots. Experience a perfect balance of traction and comfort for a confident ride.")
        item30 = Item(image = "/images/boots/boots3.png", stock=45, category="Boots", type = "Motorcycle gear" ,brand="Blaze Tech", name="BlazeFlex 5000X", price=159.99, description="Flexibility meets fashion with Blaze Tech's BlazeFlex 5000X motorcycle boots. Designed to enhance your riding experience with comfort and durability.")
